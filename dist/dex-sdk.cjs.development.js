...
var dexCoreContracts = require('@sethdao/dex-core-contracts');
...
var INIT_CODE_HASH = '0xee0a07491a10045cc1ebcc3bfe7234d24f00c7cbccf98de481e8f14bbe351c5b';
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'SETH-LP', 'Seth LP');
...
var ZERO_HEX = '0x0';
/**
 * Represents the Seth DEX Router, and has static methods for helping execute trades.
 */
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, dexCoreContracts.SethPair__factory.abi, provider).getReserves()).then(function (_ref) {
